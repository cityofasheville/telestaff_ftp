...
// takes an array of filenames, deletes table, loads file data into db, and runs stored proc. Filenames with no error are returned.
...
function load_db( filelist ) {
    return new Promise(function(resolve, reject) {
        ...
        connection.on('connect', function(err) {
            ...
            retnoerr.push([filenm]);
        });

        console.log('retnoerr', retnoerr);
        resolve( retnoerr );
    });
}
