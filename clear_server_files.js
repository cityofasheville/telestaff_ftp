...
const config = {
    ftpConfig: {
            ...
            paths_to_clear: '/DEV/import/ongoing.unprocessed/,/DEV/import/ongoing.processed/,/DEV/import/ongoing.skipped/'
    }
}
logit("Clearing files"); 

const { host, username, password, path, paths_to_clear } = config.ftpConfig;
paths_to_clear_array = paths_to_clear.split(',');
...
sftp.connect({
    ...
    return paths_to_clear_array.map(path => { //returns array of promises
